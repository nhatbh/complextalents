...
public class GunRefinementManager {
    ...
    public static double getMainstatDamageBonus(int cumulativeLevel) {
        double[] bonuses = {
            0.00, // Lv 0: Base (+0%)
            0.05, // Lv 1: Recruit +1 (+5%)
            0.12, // Lv 2: Recruit +2 (+12%)
            0.20, // Lv 3: Recruit +3 (+20%)
            0.30, // Lv 4: Recruit Max (+30%)
            0.42, // Lv 5: Trooper +1 (+42%)
            0.56, // Lv 6: Trooper +2 (+56%)
            0.72, // Lv 7: Trooper +3 (+72%)
            0.90, // Lv 8: Trooper Max (+90%)
            1.12, // Lv 9: Sergeant +1 (+112%)
            1.38, // Lv 10: Sergeant +2 (+138%)
            1.68, // Lv 11: Sergeant +3 (+168%)
            2.00, // Lv 12: Sergeant Max (+200%)
            2.40, // Lv 13: Captain +1 (+240%)
            2.85, // Lv 14: Captain +2 (+285%)
            3.35, // Lv 15: Captain +3 (+335%)
            3.85, // Lv 16: Captain Max (+385%)
            4.05, // Lv 17: General +1 (+405%)
            4.22, // Lv 18: General +2 (+422%)
            4.38, // Lv 19: General +3 (+438%)
            4.50  // Lv 20: General Max Pinnacle (+450%)
        };
